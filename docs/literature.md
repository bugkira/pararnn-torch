...
| Nested / automata / code | Merrill 2024; Dyck literature | Nonlinear RNNs are the theoretically motivated tool; Transformers win needle-in-haystack. README star table must not claim 100k retrieval. |
