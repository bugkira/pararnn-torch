...
| 2025 | Rodimus* | [Rodimus*: Breaking the Accuracy-Efficiency Trade-Off with Efficient Attentions](https://arxiv.org/abs/2410.06577) | [code](https://github.com/fla-org/flash-linear-attention/blob/main/fla/layers/rodimus.py) |
...
```
 ...
 Click to expand config and model structure 
